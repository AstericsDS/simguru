...
<html lang="{{ str_replace("_", "-", app()->getLocale()) }}">
  ...
  <body
    class="min-h-screen overflow-x-hidden text-balance bg-fixed bg-white bg-cover"
  >
    <div class="drawer min-h-screen">
      ...
      <div class="drawer-content">
        {{-- NAVBAR --}}
        <div
          class="navbar w-full bg-primary h-10 sticky transition-all top-0 z-50 px-5 lg:px-50"
          id="navbar"
        >
          <div class="navbar-start">
            ...
            >
              <img
                src="{{ asset("logos/peminjaman.png") }}"
                alt="sidebar"
                class="w-5 mr-5 lg:hidden"
              />
            </label>
            <img
              src="{{ asset("logos/unj2.png") }}"
              alt="Logo UNJ"
              class="w-3 sm:w-6 lg:w-10"
            />
          ...
          <div class="navbar-end">
            <div class="not-lg:hidden">
              <button
                id="jadwall"
                class="btn btn-ghost hover:bg-[#fddc00] hover:text-primary border-none"
    ...
    <footer
      class="footer sm:footer-horizontal bg-primary text-white mt-5 p-10 lg:px-70"
    >
      <aside>
        <img
          src="{{ asset("logos/UNJ22.png") }}"
          alt="logo unj"
          class="w-20 lg:w-50"
        />
      </aside>
