...
<body class="min-h-screen bg-[url('/public/backgrounds/unj.png')] bg-cover">
        ...
        <div class="px-3 py-3 lg:px-5">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    {{-- <button data-drawer-target="sidebar" data-drawer-toggle="sidebar" class="p-2 text-gray-500 rounded-lg sm:hidden hover:bg-gray-100">
                    ...
                    <a href="/" class="flex items-center ms-2">
                        ...
                        <span class="text-teal-700 text-lg font-extrabold leading-none">Sistem Manajemen Gedung dan Ruang<br><span class="text-teal-700 text-lg font-semibold">Universitas Negeri Jakarta</span></span>
                    </a>
                </div>
                <div class="flex items-center">
                    <div class="relative">
                        <div id="avatarButton" type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" class="relative w-10 h-10 overflow-hidden bg-gray-100 rounded-full">
    ...
    <!-- Sidebar -->
    <aside id="sidebar" class="fixed top-1 left-0 z-40 w-48 h-screen pt-20 transition-transform -translate-x-full bg-teal-700 border-r border-gray-200 sm:translate-x-0">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-teal-700">
            <ul class="space-y-2">
                <li>
                    <a href="/" class="flex items-center p-2 rounded-lg hover:bg-teal-800">
                ...
                <li>
                    <a href="/dashboard" class="flex items-center p-2 rounded-lg hover:bg-teal-800">
                        <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="/content" class="flex items-center p-2 rounded-lg hover:bg-teal-800">
