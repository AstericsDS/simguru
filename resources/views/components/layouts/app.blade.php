...
<body class="bg-gray-100 min-h-screen flex">
    ...
    >
        ...
        <ul class="mt-4 flex flex-col space-y-1 px-2">
            <li>
                <a href="{{ url('/') }}"
                    class="flex items-center p-2 text-gray-900 rounded hover:bg-teal-100 {{ $currentUrl == url('dashboard') ? 'bg-teal-200 font-semibold' : '' }}">
            ...
            <li>
                <a href="{{ url('tambah-kampus') }}"
                    class="flex items-center p-2 text-gray-900 rounded hover:bg-teal-100 {{ $currentUrl == url('tambah-kampus') ? 'bg-teal-200 font-semibold' : '' }}">
                    <span class="text-xl mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <li>
                <a href="{{ url('tambah-gedung') }}"
                    class="flex items-center p-2 text-gray-900 rounded hover:bg-teal-100 {{ $currentUrl == url('tambah-gedung') ? 'bg-teal-200 font-semibold' : '' }}">
                    <span class="text-xl mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <li>
                <a href="{{ url('tambah-ruang') }}"
                    class="flex items-center p-2 text-gray-900 rounded hover:bg-teal-100 {{ $currentUrl == url('tambah-ruang') ? 'bg-teal-200 font-semibold' : '' }}">
                    <span class="text-xl mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <li>
                <a href="{{ url('detail-all') }}"
                    class="flex items-center p-2 text-gray-900 rounded hover:bg-teal-100 {{ $currentUrl == url('veiw-detail-all') ? 'bg-teal-200 font-semibold' : '' }}">
                    <span class="text-xl mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <li>
                <a href="{{ url('rekapitulasi') }}"
                    class="flex items-center p-2 text-gray-900 rounded hover:bg-teal-100 {{ $currentUrl == url('view-rekap') ? 'bg-teal-200 font-semibold' : '' }}">
                    <span class="text-xl mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <li>
                <a href="{{ url('perubahan-data') }}"
                    class="flex items-center p-2 text-gray-900 rounded hover:bg-teal-100 {{ $currentUrl == url('perubahan-data') ? 'bg-teal-200 font-semibold' : '' }}">
                    <span class="text-xl mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
