            ...
            <div class="grid gap-4 mb-4 grid-cols-2">
              ...
              <div class="col-span-2">
                ...
                <input
                  ...
                  type="text"
                  id="floor"
                  class="bg-gray-50 border focus:outline-none focus:ring-primary transition-all text-gray-900 text-sm rounded-lg block w-full p-2.5 {{ $errors->has("floor") ? "border-red-500" : "border-gray-300" }} }}"
                />
                @error("floor")
                  <p class="mt-2 text-sm text-red-600">
                    {{ $message }}
              ...
              <div class="col-span-2">
                ...
                <input
                  ...
                  type="text"
                  id="building_area"
                  class="bg-gray-50 border focus:outline-none focus:ring-primary transition-all text-gray-900 text-sm rounded-lg block w-full p-2.5 {{ $errors->has("building_area") ? "border-red-500" : "border-gray-300" }} }}"
                />
                @error("building_area")
                  <p class="mt-2 text-sm text-red-600">
                    {{ $message }}
              ...
              <div class="col-span-2">
                ...
                <input
                  ...
                  type="text"
                  id="land_area"
                  class="bg-gray-50 border focus:outline-none focus:ring-primary transition-all text-gray-900 text-sm rounded-lg block w-full p-2.5 {{ $errors->has("land_area") ? "border-red-500" : "border-gray-300" }} }}"
                />
                @error("land_area")
                  <p class="mt-2 text-sm text-red-600">
                    {{ $message }}
          ...
          @foreach ($buildings as $building)
            ...
            >
              ...
              <td class="px-6 py-4">
                ...
                @else
                  <span class="italic">Data tidak ditemukan</span>
                @endif
              </td>
              <td class="px-6 py-4">
                {{ $building->floor }}
              ...
              <td class="px-6 py-4">
                <div class="flex gap-2">
                  ...
                  @if ($building->admin_id === Auth::id())
                    <a
                      href="{{ route("edit-gedung", $building->slug) }}"
                      wire:navigate
                      class="transition-all cursor-pointer rounded-xl p-2 mx-auto {{ in_array($building->id, $rejected_buildings) ? "text-red-500 hover:bg-red-200 tooltip tooltip-error" : "hover:text-yellow-900 hover:bg-yellow-200" }}"
                      data-tip="Perubahan ditolak"
                    >
                      <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                    <button
                      wire:click="deleteModal({{ $building->id }})"
        ...
        >
          ...
          @foreach ($updates as $update)
            ...
            >
              ...
              <td class="px-6 py-4">
                {{ number_format($update->new_data["building_area"], 0, ",", ".") }}m
                <sup>2</sup>
              </td>
              <td class="px-6 py-4">
                {{ number_format($update->new_data["land_area"], 0, ",", ".") }}m
                <sup>2</sup>
              </td>
              <td class="px-6 py-4">
                <button
              ...
              <td class="px-6 py-4">
                <div class="flex gap-2 items-center">
                  <a
                    href="{{ route("view-gedung", $update->id) }}"
                    wire:navigate
                  >
                    <button
                      class="transition-all cursor-pointer hover:text-blue-500 hover:bg-gray-300 rounded-xl p-2 mx-auto"
                  ...
                  @if ($update->admin_id === Auth::id())
                    <a
                      href="{{ route("edit-gedung", $update->id) }}"
                      wire:navigate
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <h3 class="text-lg font-semibold text-gray-900">Gambar Gedung</h3>
          <button
            @click="state = false"
            type="button"
            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center transition-all hover:cursor-pointer"
