                    ...
                    <form wire:submit.prevent='save' class="p-5">
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div class="col-span-2">
                                ...
                                <input wire:model="contact" type="text" id="contact"
                ...
                <tbody x-data="{ state: true }" x-show="state" @pending-toggle.window="state = !$event.detail">
                    @foreach ($campuses as $campus)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <button wire:click='view({{ $campus->id }})' type="button"
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-2 items-center">
                                    ...
                                    @if ($campus->admin_id === Auth::id())
                                        <a href="{{ route('edit-kampus', $campus->slug) }}" wire:navigate
                                        ...
                                        <button wire:click='deleteModal({{ $campus->id }})'
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-2 items-center">
                                    ...
                                    @if ($update->admin_id === Auth::id())
                                        <a href="{{ route('edit-kampus', $update->id) }}" wire:navigate
