<div class="text-black">
  ...
  <div class="mt-4">
    ...
    >
      <div
        x-show="state"
        class="fixed inset-0 bg-black/30 backdrop-blur-sm z-40 flex items-center justify-center overflow-y-auto"
            ...
            <div class="grid gap-4 mb-4 grid-cols-2">
              ...
              <div class="col-span-2">
                ...
                <input
                  ...
                  type="text"
                  id="contact"
                  class="bg-gray-50 border focus:outline-none focus:ring-primary transition-all text-gray-900 text-sm rounded-lg block w-full p-2.5 {{ $errors->has("contact") ? "border-red-500" : "border-gray-300" }}"
                />
                @error("contact")
                  <p class="mt-2 text-sm text-red-600">
                    {{ $message }}
    ...
    <div class="relative overflow-x-auto shadow-md rounded-lg mt-4">
      ...
      >
        ...
        >
          <tr>
            <th scope="col" class="px-6 py-3">Nama Kampus</th>
            <th scope="col" class="px-6 py-3">Jumlah Gedung</th>
            <th scope="col" class="px-6 py-3">Alamat</th>
            <th scope="col" class="px-6 py-3">Luas Kawasan</th>
            ...
            >
              ...
              <td class="px-6 py-4">
                <div class="flex gap-2 items-center">
                  <a
                    href="{{ route("view-kampus", $campus->slug) }}"
                    wire:navigate
                  >
                    <button
                  ...
                  @if ($campus->admin_id === Auth::id())
                    <a
                      href="{{ route("edit-kampus", $campus->slug) }}"
                      wire:navigate
                      class="transition-all cursor-pointer rounded-xl p-2 mx-auto {{ in_array($campus->id, $rejected_campuses) ? "text-red-500 hover:bg-red-200 tooltip tooltip-error" : "hover:text-yellow-900 hover:bg-yellow-200" }}"
          ...
          @foreach ($updates as $update)
            ...
            >
              ...
              <td class="px-6 py-4">
                <div class="flex gap-2 items-center">
                  <a
                    href="{{ route("view-kampus", $update->id) }}"
                    wire:navigate
                  >
                    <button
                      class="transition-all cursor-pointer hover:text-blue-500 hover:bg-gray-300 rounded-xl p-2 mx-auto"
                  ...
                  @if ($update->admin_id === Auth::id())
                    <a
                      href="{{ route("edit-kampus", $update->id) }}"
                      wire:navigate
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <h3 class="text-lg font-semibold text-gray-900">Gambar Kampus</h3>
          <button
            @click="state = false"
            type="button"
            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center transition-all hover:cursor-pointer"
