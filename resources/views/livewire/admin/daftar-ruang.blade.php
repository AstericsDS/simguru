    ...
    <div class="mt-4">
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-3 items-center">
                ...
                <div x-data @keyup.window="if ($event.ctrlKey && $event.key === '/') {$refs.searchInput.focus()}"
                    ...
                    <input wire:model.live="search" x-ref="searchInput" @keydown.escape="$refs.searchInput.blur()"
                        type="text"
                        class="border border-gray-300 rounded-lg px-3 py-2 w-full pl-12 pr-[88px] focus:outline-none focus:ring-unj text-black transition-all"
            ...
            <button @click="$dispatch('modal')"
                class="rounded-xl border border-gray-300 size-10 flex items-center justify-center group hover:px-2 hover:w-[100px] transition-all cursor-pointer hover:bg-unj hover:border-unj hover:text-white hover:rounded-lg overflow-hidden duration-200">
            ...
            <div x-show="state" class="fixed inset-0 bg-black/30 backdrop-blur-sm z-40 flex items-center justify-center"
                ...
                <div x-show="state" @click.outside="state = false"
                    ...
                    <form wire:submit.prevent='save' class="p-4 md:p-5">
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2">
                                ...
                                <input wire:model.live="name" type="text" id="name"
                                    class="bg-gray-50 border focus:outline-none focus:ring-unj transition-all text-gray-900 text-sm rounded-lg block w-full p-2.5 {{ $errors->has('name') ? 'border-red-500' : 'border-gray-300' }}">
                                @error('name')
                            ...
                            <div class="col-span-2">
                                ...
                                <input wire:model="area" type="text" id="area"
                                    class="bg-gray-50 border focus:outline-none focus:ring-unj transition-all text-gray-900 text-sm rounded-lg block w-full p-2.5 {{ $errors->has('area') ? 'border-red-500' : 'border-gray-300' }} }}">
                                @error('area')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-span-2">
                                ...
                                <input wire:model="capacity" type="text" id="capacity"
                                    class="bg-gray-50 border focus:outline-none focus:ring-unj transition-all text-gray-900 text-sm rounded-lg block w-full p-2.5 {{ $errors->has('capacity') ? 'border-red-500' : 'border-gray-300' }} }}">
                                @error('capacity')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <input wire:model='images_path' multiple
                                    class="block w-full text-sm text-gray-900 border rounded-lg cursor-pointer bg-gray-50 focus:outline-none focus:ring-unj transition-all {{ $errors->has('images_path') ? 'border-red-500' : 'border-gray-300' }}"
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea wire:model="description" id="description" rows="4"
                                    class="bg-gray-50 border focus:outline-none focus:ring-unj transition-all text-gray-900 text-sm rounded-lg block w-full p-2.5 {{ $errors->has('description') ? 'border-red-500' : 'border-gray-300' }}"></textarea>
                                @error('description')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        {{-- Submit --}}
                        <div @toast.window="state = false" class="flex justify-end mt-8">
                            <button type="submit"
                                class="px-4 py-2 text-gray-900 font-semibold border-3 border-unj rounded-lg cursor-pointer hover:bg-unj hover:text-white transition-all focus:outline-none focus:bg-unj focus:text-white">
                                Tambah
                            </button>
                        </div>
                    </form>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <button wire:click='view({{ $room->id }})' type="button"
                                    class="transition-all cursor-pointer hover:text-unj hover:bg-unj-light rounded-xl p-2 mx-auto"
                                    data-tip="Gambar">
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                @if ($update->new_data['category'] === 'class')
                                    <span class="px-2 py-1 rounded-lg bg-unj text-white">Kelas</span>
