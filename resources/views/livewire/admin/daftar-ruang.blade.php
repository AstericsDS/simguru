<div class="text-black">
  ...
  <div class="mt-4">
    <div class="flex justify-between items-center gap-2">
      <div class="flex gap-3 items-center">
        ...
        <div
          x-data
          @keyup.window="if ($event.ctrlKey && $event.key === '/') {$refs.searchInput.focus()}"
          class="relative md:w-96 w-full"
        >
          <span
            class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 cursor-pointer"
          >
            <svg
          ...
          <div
            class="absolute right-4 text-gray-500 top-1/2 -translate-y-1/2 md:flex gap-1 hidden"
          >
            <div
              class="border px-2 py-1 border-gray-500 rounded-md flex items-center justify-center"
            >
              <span class="text-xs">CTRL</span>
            </div>
            <div
              class="border p-2 py-1 border-gray-500 rounded-md flex items-center justify-center"
            >
        ...
        <div
          x-data="{ state: false }"
          @click="state = !state; $dispatch('pending-toggle', state)"
      ...
      >
        ...
        <span class="hidden group-hover:inline transition-all font-semibold">
          Tambah
        </span>
      </button>
    </div>
    ...
    <div
      x-data="{
        ...
        toggle: 'form',
        switchView() {
          this.toggle = this.toggle === 'form' ? 'inventory' : 'form'
        },
      }"
      ...
      >
        ...
        >
          ...
          >
            ...
            <div class="grid gap-4 mb-4 grid-cols-2">
              ...
              <div class="col-span-2">
                ...
                <textarea
                  ...
                  id="description"
                  rows="4"
                  class="bg-gray-50 border focus:outline-none focus:ring-primary transition-all text-gray-900 text-sm rounded-lg block w-full p-2.5 {{ $errors->has("description") ? "border-red-500" : "border-gray-300" }}"
                ></textarea>
                @error("description")
                  <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                    {{ $message }}
            ...
            {{-- Submit --}}
            <div
              @close-modal.window="state = false"
          ...
          <div
            x-data="{
              items: @entangle("inventory"),
              addItem() {
                this.items.push({ name: '', quantity: 1 })
              },
            }"
            class="p-5"
            x-show="toggle === 'inventory'"
            x-transition:enter="transition ease-out duration-300"
            x-transition:enter-start="opacity-0 scale-90"
            x-transition:enter-end="opacity-100 scale-100"
          >
    ...
    <div class="relative overflow-x-auto shadow-md rounded-lg mt-4">
      ...
      >
        ...
        >
          <tr>
            <th scope="col" class="px-6 py-3">Nama Ruang</th>
            <th scope="col" class="px-6 py-3">Lokasi Kampus</th>
            ...
            <th scope="col" class="px-6 py-3">Tinggi</th>
            <th scope="col" class="px-6 py-3">Jenis Ruang</th>
            <th scope="col" class="px-6 py-3">Penyewaan</th>
            <th scope="col" class="px-6 py-3">Visibilitas</th>
        ...
        <tbody
          x-data="{ state: true }"
          x-show="state"
          @pending-toggle.window="state = !$event.detail"
        >
            ...
            >
              ...
              <td class="px-6 py-4">
                <div class="flex gap-2">
                  <a
                    href="{{ route("view-ruang", $room->slug) }}"
                    wire:navigate
                  >
                    <button
                  ...
                  @if ($room->admin_id === Auth::user()->role || Auth::user()->role === "1")
                    ...
                    <button
                      wire:click="deleteModal({{ $room->id }})"
        ...
        >
          ...
          @foreach ($updates as $update)
            ...
            >
              ...
              <td class="px-6 py-4">
                {{ $update->new_data["length"] }} m
                <sup>2</sup>
              </td>
              <td class="px-6 py-4">
                {{ $update->new_data["width"] }} m
                <sup>2</sup>
              </td>
              <td class="px-6 py-4">
                {{ $update->new_data["height"] }} m
                <sup>2</sup>
              </td>
              <td class="px-6 py-4">
              ...
              <td class="px-6 py-4">
                <button
                  wire:click="viewPending({{ $update->id }})"
                  type="button"
                  class="transition-all cursor-pointer hover:text-primary hover:bg-primary-light rounded-xl p-2 mx-auto"
                  data-tip="Gambar"
                >
              ...
              <td class="px-6 py-4">
                <div class="flex gap-2 items-center">
                  <a
                    href="{{ route("view-ruang", $update->id) }}"
                    wire:navigate
                  >
                    <button
                      class="transition-all cursor-pointer hover:text-blue-500 hover:bg-gray-300 rounded-xl p-2 mx-auto"
  ...
  >
    ...
    >
      ...
      >
        <!-- Modal header -->
        <div
          class="flex items-center justify-between border-b rounded-t border-gray-200 p-8 pb-6"
        >
          <h3 class="text-lg font-semibold text-gray-900">Gambar Ruang</h3>
          <button
            @click="state = false"
            type="button"
            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center transition-all hover:cursor-pointer"
        ...
        <!-- Modal body -->
        <div
          class="p-8 pt-0 tooltip tooltip-accent w-full"
          data-tip="Scroll untuk melihat gambar"
        >
  ...
  <div
    x-data="{ state: false }"
    @confirm-delete.window="state = !state"
    @keydown.window.escape="state = false"
  >
    <div
      x-show="state"
