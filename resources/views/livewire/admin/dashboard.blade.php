<div class="mt-4">
  <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-6">
    <div class="bg-white rounded-lg shadow p-5">
      ...
      <h4
        class="text-2xl font-semibold mb-3 flex items-center gap-2 text-slate-500"
      >
        <span
          class="inline-flex items-center px-2 py-1 text-s font-medium bg-blue-100 text-blue-700 rounded border border-blue-700"
        >
      ...
      <p class="text-sm text-gray-500">
        Sebanyak
        <span class="text-blue-600">{{ $campusCount }}</span>
        Kampus yang terdaftar di UNJ
      </p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-5">
      ...
      >
        <span
          class="inline-flex items-center px-2 py-1 text-s font-medium bg-green-100 text-green-700 rounded border border-green-700"
        >
          <i class="ti ti-trending-up"></i>
          {{ $buildingCount }}
        </span>
      ...
      <p class="text-sm text-gray-500">
        Sebanyak
        <span class="text-green-600">{{ $buildingCount }}</span>
        Gedung yang terdaftar di UNJ
      </p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-5">
      ...
      >
        <span
          class="inline-flex items-center px-2 py-1 text-s font-medium bg-yellow-100 text-yellow-700 rounded border border-yellow-700"
        >
      ...
      <p class="text-sm text-gray-500">
        Sebanyak
        <span class="text-yellow-600">{{ $roomCount }}</span>
        Ruang yang terdaftar di UNJ
      </p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-5">
      ...
      >
        <span
          class="inline-flex items-center px-2 py-1 text-s font-medium bg-red-100 text-red-700 rounded border border-red-700"
        >
          <i class="ti ti-trending-down"></i>
          {{ $classCount }}
        </span>
      ...
      <p class="text-sm text-gray-500">
        Sebanyak
        <span class="text-red-600">{{ $classCount }}</span>
        Ruang yang terdaftar sebagai Kelas
      </p>
    </div>
  </div>
  ...
  <div class="bg-white rounded-lg shadow p-5 mb-6">
    <div class="flex justify-between items-center mb-4">
      <h5 class="text-lg font-semibold">
        Statistik Penggunaan Gedung dan Ruang (BLOM SINKRON)
      </h5>
      <div class="space-x-2">
        <button id="btn-bulan" class="bg-blue-600 text-white px-3 py-1 rounded">
          Bulan
        </button>
        <button
          id="btn-minggu"
  ...
  <div class="bg-white rounded-lg shadow p-5">
    <h5 class="text-lg font-semibold mb-4">
      Status Penggunaan Gedung dan Ruang (BLOM SINKRON)
    </h5>
    <div class="overflow-x-auto">
      <table class="min-w-full divide-y divide-gray-200 text-sm">
        ...
        <tbody class="divide-y divide-gray-100">
          ...
          <tr>
            <td class="px-4 py-2 text-gray-600">
              <a href="#" class="hover:underline">KAMPUS D</a>
            </td>
    ...
    const initDashboardCharts = () => {
      ...
      var optionsBulan = {
        ...
        series: [
          {
            name: 'Penggunaan',
            data: [300, 400, 350, 450, 420, 480, 460, 500, 480, 510, 530, 520],
          },
        ],
        xaxis: {
          categories: [
        ...
        series: [
          {
            name: 'Penggunaan',
            data: [
              2, 3, 5, 8, 15, 25, 30, 32, 35, 33, 28, 20, 18, 15, 12, 10, 8, 5,
              4, 3, 2, 1, 1, 0,
            ],
          },
        ],
