    ...
    <form wire:submit.prevent="showModal">
        ...
        <div class="w-full flex flex-col gap-5">
          ...
          >
            ...
            <select
              ...
              id="campus"
              class="bg-gray-50 border border-gray-300 {{ $is_pending ? "text-gray-500" : "text-gray-900" }} text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 {{ $errors->has("campus_id") ? "border-red-500" : "border-gray-300" }}"
              {{ $is_pending ? "disabled" : "" }}
            >
          ...
          >
            ...
            <input
              ...
              type="text"
              id="floor"
              class="bg-gray-50 border focus:outline-none focus:ring-primary transition-all {{ $is_pending ? "text-gray-500" : "text-gray-900" }} text-sm rounded-lg block w-full p-2.5 {{ $errors->has("floor") ? "border-red-500" : "border-gray-300" }} my-2"
              {{ $is_pending ? "disabled" : "" }}
            />
            @error("floor")
              <p class="text-sm text-red-600">{{ $message }}</p>
          ...
          >
            ...
            <input
              wire:model.live="building_area"
              type="text"
              id="building_area"
              class="bg-gray-50 border focus:outline-none focus:ring-primary transition-all {{ $is_pending ? "text-gray-500" : "text-gray-900" }} text-sm rounded-lg block w-full p-2.5 {{ $errors->has("building_area") ? "border-red-500" : "border-gray-300" }} my-2"
              {{ $is_pending ? "disabled" : "" }}
            />
            @error("building_area")
              <p class="text-sm text-red-600">{{ $message }}</p>
          ...
          >
            ...
            <input
              wire:model.live="land_area"
              type="text"
              id="land_area"
              class="bg-gray-50 border focus:outline-none focus:ring-primary transition-all {{ $is_pending ? "text-gray-500" : "text-gray-900" }} text-sm rounded-lg block w-full p-2.5 {{ $errors->has("land_area") ? "border-red-500" : "border-gray-300" }} my-2"
              {{ $is_pending ? "disabled" : "" }}
            />
            @error("land_area")
              <p class="text-sm text-red-600">{{ $message }}</p>
      ...
      <div class="flex justify-end mt-8">
        <button
          ...
          type="submit"
          class="p-2 border-[2px] border-primary rounded-md px-8 transition-all font-semibold {{ $is_pending ? "cursor-not-allowed" : "hover:bg-primary hover:text-white cursor-pointer" }}"
        >
          <span wire:loading.remove wire:target="new_images,new_documents">
            Simpan
          </span>
          <span wire:loading wire:target="new_images,new_documents">
            Mengupload
          </span>
        </button>
      </div>
