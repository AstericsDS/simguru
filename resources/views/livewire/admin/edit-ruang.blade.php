<div class="text-black">
  ...
  <div
    x-data="{ state: true }"
    x-show="state"
    @toggle-inventory.window="state = !state"
    class="mt-8"
  ...
  >
    <form wire:submit.prevent="showModal">
      <div
        class="flex flex-col-reverse xl:grid xl:grid-cols-2 gap-8 items-start"
      >
        <div class="w-full flex flex-col gap-5">
          <div
            class="{{ $is_pending ? "tooltip tooltip-accent" : "" }}"
        ...
        <div class="w-full flex flex-col gap-5">
          ...
          <div class="flex justify-end">
            <div
              class="flex justify-center items-center space-x-2 hover:text-primary transition-all cursor-pointer px-4 py-1 border-2 border-primary rounded-md"
          ...
          <div class="flex w-full justify-center gap-2 py-2">
            ...
            >
              <label
                class="btn btn-md font-semibold {{ $is_pending ? "btn-disabled" : "" }}"
              >
                +
                <input
          ...
          <div class="bg-gray-300 p-5 rounded-md max-h-50 overflow-y-auto">
            ...
            {{-- Body --}}
            <ul
              class="mt-3 space-y-2 list-disc list-inside marker:text-primary"
            >
                ...
                <div class="flex justify-between">
                  @if ($document instanceof \Illuminate\Http\UploadedFile)
                    <li>
                      ...
                      >
                        {{ basename($document->getClientOriginalName()) }}
                      </span>
                    </li>
                  @else
                    <li>
      ...
      <div class="flex justify-end mt-8">
        <button
          type="submit"
          class="p-2 border-2 border-primary rounded-md px-8 transition-all font-semibold {{ $is_pending ? "cursor-not-allowed" : "hover:bg-primary hover:text-white cursor-pointer" }}"
        >
          Simpan
        </button>
      </div>
  ...
  >
    ...
    <div class="flex items-center justify-between mb-5">
      ...
      {{-- Inventory Toggle --}}
      <div
        class="flex items-center justify-center border-2 space-x-1 rounded-md border-primary px-4 py-1 hover:text-primary transition-all cursor-pointer"
        @click="$dispatch('toggle-inventory')"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
