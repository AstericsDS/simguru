<div class="w-full px-5 lg:px-40">
  ...
  <div class="flex flex-col mt-5">
    <a href="/" class="size-5">
      <img src="{{ asset("logos/back-svgrepo-com.svg") }}" alt="" />
    </a>
  ...
  <div
    class="flex justify-between items-center mb-3 mt-10 border-t border-gray-300 pt-3"
  >
  ...
  <div class="grid grid-cols-1 gap-3 mt-12 text-white">
    <div class="bg-[#006569] collapse collapse-arrow border border-gray-300">
      ...
      <div class="collapse-title bg-[#006569] text-xl font-bold">Lantai 1</div>
        ...
        <div class="card card-sm bg-[#006569] shadow-xl h-max">
          <div class="flex items-center justify-between p-3">
            ...
            <div>
              <a
                href=""
                class="btn btn-md place-content-end bg-white text-black border-none hover:bg-gray-200"
              >
                Details
              </a>
            </div>
    ...
    <div class="bg-[#006569] collapse collapse-arrow border border-gray-300">
      <input type="checkbox" class="peer" />
      <div class="collapse-title bg-[#006569] text-xl font-bold">Lantai 2</div>
      <div class="collapse-content grid gap-2 bg-white peer-checked:pt-5">
        <div class="card card-sm bg-[#006569] shadow-xl h-max">
          <div class="flex justify-between p-2">
            ...
            <a
              href=""
              class="btn bg-white text-black border-none hover:bg-gray-200"
            >
              Details
            </a>
          </div>
