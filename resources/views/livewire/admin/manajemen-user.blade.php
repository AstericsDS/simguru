<div>
  <div class="flex justify-between">
    ...
    >
      ...
      <span class="hidden group-hover:inline transition-all font-semibold ml-2">
        Tambah
      </span>
    </button>
  </div>
          ...
          <div class="grid gap-4 mb-4 grid-cols-2">
            <div class="col-span-2">
              ...
              <input
                ...
                type="text"
                id="name"
                class="bg-gray-50 border focus:outline-none focus:ring-primary transition-all text-gray-900 text-sm rounded-lg block w-full p-2.5 {{ $errors->has("email") ? "border-red-500" : "border-gray-300" }}"
              />
              @error("email")
            ...
            <div class="col-span-2">
              <label
                for="campus"
                class="block mb-2 text-sm font-medium {{ $errors->has("role") ? "text-red-700" : "text-gray-900" }}"
              >
                Role User
              </label>
              <select
                wire:model="role"
                id="campus"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 {{ $errors->has("role") ? "border-red-500" : "border-gray-300" }}"
              >
