                ...
                @foreach ($rooms as $room)
                    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="p-5">
                            ...
                            <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-unj rounded-lg hover:bg-unj-dark transition-all focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Booking
                ...
                <div class="flex flex-col gap-2 p-8 pt-0 mt-8">
                    ...
                    <div class="grid grid-cols-[275px_1fr]">
                        ...
                        <div class="flex gap-4">
                            <span>:</span>
                            <form class="flex-1">
                                <input wire:model="address" type="text" id="address" class="bg-gray-50 border focus:outline-none focus:ring-unj transition-all text-gray-900 text-sm rounded-lg w-full {{ $errors->has('address') ? 'border-red-500' : 'border-gray-300' }}">
                            </form>
                        </div>
                    </div>
                    <div class="self-end mt-4">
                        <button wire:click='save' class="px-4 py-2 rounded-md  hover:bg-green-500 transition-all cursor-pointer text-green-500 text-lg border-2 border-green-500 hover:text-white">Buat Acara</button>
                    </div>
                </div>
            </div>
        </div>
