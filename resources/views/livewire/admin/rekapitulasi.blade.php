<div class="mt-4">
  ...
  <div class="flex justify-end items-center gap-2 mt-10 mb-3">
    ...
    <button
      data-modal-target="modalTambahGedung"
      data-modal-toggle="modalTambahGedung"
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      <div class="relative bg-white rounded-lg shadow">
        ...
        <form class="p-6 space-y-4 overflow-y-auto max-h-[70vh]">
          <div
            class="bg-blue-50 border-l-4 border-blue-400 text-blue-700 p-3 rounded"
          >
          ...
          <div>
            ...
            <small class="text-gray-500 block mt-1">
              Pilih satu atau beberapa dokumen (PDF, Word, Excel, PPT, TXT, ZIP,
              RAR).
            </small>
          </div>
  ...
  <!-- Tabel Rekap Gedung -->
  <div
    class="overflow-x-auto bg-white rounded shadow mt-8 max-h-[70vh] overflow-y-auto"
  >
    <table
      class="min-w-full text-xs md:text-sm border-collapse border border-gray-300 table table-bordered"
    >
      <thead
        class="bg-teal-700 text-white text-center table-success sticky top-0 z-10"
      >
        <tr>
          <th>No</th>
          <th>Nama Kampus</th>
          ...
          <th>Mushalla</th>
          <th>
            R. Dapur / R. Makan / Smooking Room / R. Laktasi / Pantry / Janitor
          </th>
        ...
        <tr>
          ...
          <td class="flex flex-col gap-2">
            ...
            <a
              href="edit-kampus"
              type="button"
              class="inline-flex items-center gap-2 px-1 py-1.5 text-xs font-medium text-center text-white bg-yellow-500 rounded-sm hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <a
              href=""
              type="button"
              class="inline-flex items-center gap-2 px-1 py-1.5 text-xs font-medium text-center text-white bg-red-700 rounded-sm hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
