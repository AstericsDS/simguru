<div>
  ...
  <div class="mt-6">
    ...
    <div
      x-data="{ show: true }"
      x-show="show"
      @toggle-calendar.window="show = !show"
      x-transition:enter="transition ease-out duration-300"
      x-transition:enter-start="opacity-0 scale-90"
      x-transition:enter-end="opacity-100 scale-100"
      class="flex xl:gap-8 gap-2 xl:grid xl:grid-cols-2 flex-col-reverse"
    >
      <div class="flex flex-col flex-4 gap-3">
        ...
        <div class="flex gap-4 mt-4">
          <button
            @click="$dispatch('toggle-calendar')"
      ...
      {{-- Slider --}}
      <div
        class="w-full xl:w-fit relative rounded-md overflow-hidden xl:flex-3"
      >
    ...
    >
      ...
      <div class="mt-4 flex gap-4 justify-end">
        <button
          @click="$dispatch('toggle-calendar')"
          class="p-2 text-red-600 cursor-pointer hover:text-red-800 rounded-md px-4 transition-all"
        >
          Kembali
        </button>
      </div>
  ...
  <div
    x-data="{
      ...
      changeTab(newTab) {
        this.direction =
          newTab === 'kuliah' && this.tab === 'biasa' ? 'right' : 'left'
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <h3 class="text-lg font-semibold text-gray-900">Tambah Acara</h3>
          <button
            @click="state = false"
            type="button"
        ...
        {{-- Modal content --}}
        <div
          class="relative flex flex-col gap-5 p-8 pt-0 mt-8 min-h-[400px] overflow-hidden"
        >
          ...
          <div class="self-end mt-4 relative z-10">
            <button
              ...
              class="px-4 py-2 rounded-md hover:bg-primary transition-all cursor-pointer text-primary text-lg border-2 border-primary hover:text-white"
            >
              Simpan
            </button>
          </div>
  ...
  <div
    x-data="{ state: false }"
    @confirm-modal.window="state = !state"
    @keydown.window.escape="state = false"
  >
    <div
      x-show="state"
      ...
      >
        <div class="flex flex-col items-center py-8">
          ...
          <div class="flex gap-6">
            <button
              wire:click="save"
              class="px-8 py-2 rounded-md bg-primary hover:bg-primary-dark transition-all cursor-pointer text-white text-xl"
            >
              Iya
            </button>
            <button
              @click="$dispatch('confirm-modal')"
              class="px-8 py-2 rounded-md border-2 border-red-300 hover:bg-red-400 hover:border-red-400 transition-all cursor-pointer text-xl hover:text-white"
            >
              Tidak
            </button>
          </div>
