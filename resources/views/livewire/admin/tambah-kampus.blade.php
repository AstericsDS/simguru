                ...
                <div class="relative bg-white rounded-lg shadow-sm w-2xl p-2">
                    ...
                    <form wire:submit.prevent='save' class="p-4 md:p-5">
                        ...
                        <div class="flex justify-end">
                            <button type="submit" class="text-white inline-flex items-center bg-teal-700 hover:bg-teal-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center cursor-pointer transition-all focus:bg-teal-800">
                                Tambah
                            </button>
                        </div>
                    </form>
