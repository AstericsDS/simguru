...
<div class="container mt-4">
    ...
    <div class="flex justify-end items-center mb-3">
        ...
        <!-- Modal toggle -->
        <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="inline-flex items-center btn text-white bg-teal-700 px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-full text-sm px-5 py-2.5 text-center" type="button">
