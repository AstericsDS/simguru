<div>
  ...
  <div class="flex gap-8 xl:flex-row flex-col">
    ...
    <div class="flex-4">
      <h1 class="text-4xl">
        {{ $building->name ?? $pending->new_data["name"] }}
      </h1>
      <div class="mt-4 flex flex-col gap-3">
        <div
          class="grid grid-cols-[40%_1fr] md:grid-cols-[25%_1fr] lg:grid-cols-[20%_1fr]"
        >
          <span>Nama</span>
        ...
        >
          ...
          <div class="flex gap-3">
            <span>:</span>
            <span>
              {{ $building->building_area ?? $pending->new_data["building_area"] }}
              m
              <sup>2</sup>
            </span>
          </div>
        ...
        >
          ...
          <div class="flex gap-3">
            <span>:</span>
            <span>
              {{ $building->land_area ?? $pending->new_data["land_area"] }}
              m
              <sup>2</sup>
            </span>
          </div>
        ...
        >
          ...
          <div class="flex gap-3">
            <span>:</span>
            <span>
              {{ $building->floor ?? $pending->new_data["floor"] }}
            </span>
          </div>
        </div>
        <div
