<div>
  ...
  <div
    ...
    class="flex gap-8 xl:flex-row flex-col"
  ...
  >
    ...
    <div class="flex flex-col gap-4 xl:flex-3">
      ...
      <div class="flex justify-end space-x-4 items-center">
        ...
        {{-- Inventory Toggle --}}
        <div
          class="hover:text-primary transition-all cursor-pointer"
    ...
    <div class="flex-4">
      <h1 class="text-4xl">
        {{ $room->name ?? $pending->new_data["name"] }}
      </h1>
      <div class="mt-4 flex flex-col gap-3">
        ...
        <div class="grid grid-cols-[23%_1fr] lg:grid-cols-[25%_1fr]">
          ...
          <div class="flex gap-3">
            <span>:</span>
            <span>
              {{ $room->campus->name ?? $pending->new_data["campus"] }}
            </span>
          </div>
        </div>
        <div class="grid grid-cols-[23%_1fr] lg:grid-cols-[25%_1fr]">
          ...
          <div class="flex gap-3">
            <span>:</span>
            <span>
              {{ $room->building->name ?? $pending->new_data["building"] }}
            </span>
          </div>
        </div>
        <div class="grid grid-cols-[23%_1fr] lg:grid-cols-[25%_1fr]">
          ...
          <div class="flex gap-3">
            <span>:</span>
            <span>
              {{ $room->floor ?? $pending->new_data["floor"] }}
            </span>
          </div>
        </div>
        <div class="grid grid-cols-[23%_1fr] lg:grid-cols-[25%_1fr]">
          ...
          <div class="flex gap-3">
            <span>:</span>
            <span>
              {{ $room->capacity ?? $pending->new_data["capacity"] }}
              orang
            </span>
          </div>
        </div>
        <div class="grid grid-cols-[23%_1fr] lg:grid-cols-[25%_1fr]">
          ...
          <div class="flex gap-3">
            <span>:</span>
            <span>
              {{ $room->length ?? $pending->new_data["length"] }}
              m
            </span>
          </div>
        </div>
        ...
        <div class="grid grid-cols-[23%_1fr] lg:grid-cols-[25%_1fr]">
          ...
          <div class="flex gap-3">
            <span>:</span>
            <span>
              {{ $room->height ?? $pending->new_data["height"] }}
              m
            </span>
          </div>
        </div>
        ...
        >
          ...
          <div class="flex gap-3">
            <span>:</span>
            <span>
              {{ ($room->rentable ? "Disewakan" : "Tidak Disewakan") ?? $pending->new_data["rentable"] }}
            </span>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div class="flex gap-3">
            <span>:</span>
            <span>
              {{ ($room->show ? "Publik" : "Privat") ?? $pending->new_data["show"] }}
            </span>
          </div>
        </div>
        <div
  ...
  >
    <div class="rounded-md mt-4">
      <div class="flex justify-between items-center">
        ...
        {{-- Inventory Toggle --}}
        <div
          class="flex items-center justify-center size-8 hover:text-primary transition-all cursor-pointer text-xl"
          @click="$dispatch('toggle-inventory')"
        >
      ...
      <table class="w-full border border-gray-400 mt-4">
        <thead>
          <tr>
            <th class="text-left font-normal border border-gray-400 p-2 px-4">
              Nama Barang
            </th>
            <th class="text-left font-normal border border-gray-400 p-2 px-4">
              Kuantitas
