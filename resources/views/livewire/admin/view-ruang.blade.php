<div>
    ...
    {{-- Detail Kampus --}}
    <div x-data="{ state: true }" x-show="state" @toggle-inventory.window="state = !state" class="flex gap-8" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100">
    ...
    {{-- Inventory --}}
    <div x-data="{ state: false }" x-show="state" @toggle-inventory.window="state = !state" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100">
        <div class="rounded-md mt-4">
            ...
            <div class="flex justify-between items-center">
                ...
                {{-- Inventory Toggle --}}
                <div class="flex items-center justify-center size-8  hover:text-primary transition-all cursor-pointer text-xl" @click="$dispatch('toggle-inventory')">
