...
<div>
    <div class="flex justify-around p-6 bg-gray-100">
        ...
        <div class="max-w-sm p-6 bg-white rounded-lg shadow-md text-center mr-4">
            <h3 class="text-xl font-semibold mb-2">Jumlah Kampus</h3>
        ...
        <div class="max-w-sm p-6 bg-white rounded-lg shadow-md text-center ml-4 mr-4">
            <h3 class="text-xl font-semibold mb-2">Jumlah Gedung</h3>
        ...
        <!-- Card Ruang -->
        <div class="max-w-sm p-6 bg-white rounded-lg shadow-md text-center ml-4 mr-4">
            <h3 class="text-xl font-semibold mb-2">Jumlah Ruang</h3>
    ...
    <div class="max-w-full w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6 mt-6">
    <div class="flex justify-between mb-3">
        <div class="flex justify-center items-center">
            <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white pe-1">Informasi Kampus</h5>
            ...
            <div data-popover id="chart-info" role="tooltip" class="absolute z-10 invisible inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-xs opacity-0 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
                <div class="p-3 space-y-2">
                    <h3 class="font-semibold text-gray-900 dark:text-white">Kampus, Gedung, dan Ruang</h3>
                    ...
                    <h3 class="font-semibold text-gray-900 dark:text-white">Keterangan</h3>
                    ...
                    <a href="#" class="flex items-center font-medium text-blue-600 dark:text-blue-500 dark:hover:text-blue-600 hover:text-blue-700 hover:underline">Pelajari lebih lanjut <svg class="w-2 h-2 ms-1.5 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
    ...
    <div>
        ...
        <div class="flex items-center me-4">
            ...
            <label for="desktop" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Gedung A</label>
        </div>
        <div class="flex items-center me-4">
            ...
            <label for="tablet" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Gedung B</label>
        </div>
        <div class="flex items-center me-4">
            ...
            <label for="mobile" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Gedung C</label>
        </div>
        </div>
    </div>
