<div class="container py-5 px-40">
  <div class="flex flex-col mt-5">
    <a href="" class="text-[#006569] size-5"><img src="{{ asset('logos/back-svgrepo-com.svg')}}" alt=""></a>
    ...
    <div class="group grid grid-flow-col-dense grid-rows-4 gap-4 justify-items-start text-[#006569]">
      <div class="row-span-4">
        <div class="carousel w-134">
          <div id="slide1" class="carousel-item relative w-134">
            <img
          ...
          <div id="slide2" class="carousel-item relative w-134">
            <img
          ...
          <div id="slide3" class="carousel-item relative w-134">
            <img
          ...
          <div id="slide4" class="carousel-item relative w-134">
            <img
      ...
      <div class="font-bold text-4xl">KAMPUS A</div>
