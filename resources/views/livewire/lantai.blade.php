            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-black md:ml-2">Lantai</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        @foreach(range('1', '4') as $building)
            <div class="bg-green-900 rounded-lg shadow-md overflow-hidden border border-gray-700 transition-transform hover:scale-[1.02]">
                ...
                <div class="h-48 bg-gray-800 flex items-center justify-center">
                    <img src="logos/lantai.png" alt="Gedung {{ $building }}" class="h-full w-full object-cover opacity-90">
                </div>
                
                <!-- Konten Alamat -->
                <div class="p-4">
                    <h2 class="text-xl font-bold text-white mb-3">Lantai {{ $building }}</h2>
                    
                    <div class="space-y-1 text-gray-300 text-sm">
                        <p>Lantai ini berisikan sesuatu</p>
                        <p>Berkapasitas 10 ruangan</p>
                    </div>
