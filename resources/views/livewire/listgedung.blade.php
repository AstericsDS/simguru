<div class="w-full px-5 lg:px-40">
  <h1 class="mt-10 mb-2 text-black text-3xl text-center font-bold">
    List SEMUA Gedung di Universitas Negeri Jakarta
  </h1>
    ...
    @foreach ($buildings as $building)
      <div class="card bg-primary shadow-lg">
        ...
        <div class="card-body items-center text-center">
          ...
          <p class="text-xs text-center mb-3 not-lg:hidden">
            {{ $building->address }}
          </p>
          <a
            href="/kampus/{{ $building->slug }}"
            class="btn border-none bg-white text-black outline-none hover:bg-gray-200 rounded-lg w-full"
          >
            Details
          </a>
        </div>
