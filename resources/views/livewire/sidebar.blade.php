<nav
  ...
  class="bg-white dark:bg-surface-a10 shadow-md flex flex-col fixed left-0 top-0 h-screen z-30 overflow-hidden transition-width duration-300 ease-in-out"
  style="min-width: 64px"
>
  <div class="flex items-center p-4 space-x-2">
    <img src="/logos/unj.png" alt="logo" class="w-10 h-auto" />
    <span
      class="text-teal-800 dark:text-primary-a0 font-bold text-3xl truncate ml-3"
  ...
  <ul class="mt-4 flex flex-col space-y-1 px-2">
    <li>
      <a
        ...
        class="transition-all flex items-center p-2 text-gray-700 {{ $currentRouteName == "dashboard" ? "bg-active-side text-teal-800 font-medium border-r-[3px]" : "hover:text-gray-950" }} text-center overflow-hidden"
      >
    ...
    <li
      class="mt-6 mb-2 px-2 text-xs font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap"
    ...
    <li>
      <a
        ...
        class="transition-all flex items-center p-2 text-gray-700 overflow-hidden {{ $currentRouteName == "daftar-kampus" || $currentRouteName == "edit-kampus" ? "bg-active-side text-teal-800 font-medium border-r-[3px]" : "hover:text-gray-950" }}"
      >
        <span class="text-xl ml-2 mr-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    <li>
      <a
        wire:navigate
        href="{{ route("daftar-gedung") }}"
        class="transition-all flex items-center p-2 text-gray-700 {{ $currentRouteName == "daftar-gedung" || $currentRouteName == "edit-gedung" ? "bg-active-side text-teal-800 font-medium border-r-[3px]" : "hover:text-gray-950" }}"
      >
        <span class="text-xl ml-2 mr-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            ...
            <path
              fill="currentColor"
              d="M2 19V5q0-.825.588-1.412T4 3h6q.825 0 1.413.588T12 5v2h8q.825 0 1.413.588T22 9v10q0 .825-.587 1.413T20 21H4q-.825 0-1.412-.587T2 19m2 0h2v-2H4zm0-4h2v-2H4zm0-4h2V9H4zm0-4h2V5H4zm4 12h2v-2H8zm0-4h2v-2H8zm0-4h2V9H8zm0-4h2V5H8zm4 12h8V9h-8v2h2v2h-2v2h2v2h-2zm4-6v-2h2v2zm0 4v-2h2v2z"
            />
          </svg>
        </span>
        <span
    ...
    <li>
      <a
        ...
        class="transition-all flex items-center p-2 text-gray-700 {{ $currentRouteName == "daftar-ruang" || $currentRouteName == "edit-ruang" ? "bg-active-side text-teal-800 font-medium border-r-[3px]" : "hover:text-gray-950" }}"
      >
        <span class="text-xl ml-2 mr-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    <li
      ...
      :class="sidebarOpen ? 'block' : 'hidden'"
    >
      Menu Peminjaman Ruang
    </li>

    <li>
      <a
        wire:navigate
        href="{{ route("peminjaman-ruang") }}"
        class="transition-all flex items-center p-2 text-gray-700 {{ $currentRouteName == "peminjaman-ruang" || $currentRouteName == "reservasi-ruang" ? "bg-active-side text-teal-800 font-medium border-r-[3px]" : "hover:text-gray-950" }}"
      >
        <span class="text-xl ml-2 mr-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            ...
            <path
              fill="currentColor"
              d="M7 18q-2.5 0-4.25-1.75T1 12t1.75-4.25T7 6q1.65 0 3.025.825T12.2 9H21q.825 0 1.413.588T23 11v2q0 .825-.587 1.413T21 15v1q0 .825-.587 1.413T19 18h-2q-.825 0-1.412-.587T15 16v-1h-2.8q-.8 1.35-2.175 2.175T7 18m0-2q1.65 0 2.65-1.012T10.85 13H17v3h2v-3h2v-2H10.85q-.2-.975-1.2-1.987T7 8T4.175 9.175T3 12t1.175 2.825T7 16m0-2q.825 0 1.413-.587T9 12t-.587-1.412T7 10t-1.412.588T5 12t.588 1.413T7 14m0-2"
            />
          </svg>
        </span>
        <span
    ...
    <li class="hidden">
      <a
        wire:navigate
        href="{{ route("detail-all") }}"
        class="transition-all flex items-center p-2 text-gray-700 {{ $currentRouteName == "detail-all" ? "bg-active-side text-teal-800 font-medium border-r-[3px]" : "hover:text-gray-950" }}"
      >
        <span class="text-xl ml-2 mr-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    <li class="hidden">
      <a
        ...
        class="transition-all flex items-center p-2 text-gray-700 {{ $currentRouteName == "rekapitulasi" ? "bg-active-side text-teal-800 font-medium border-r-[3px]" : "hover:text-gray-950" }}"
      >
        <span class="text-xl ml-2 mr-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    @if (Auth::user()->role == 1)
      <li>
        <a
          ...
          class="transition-all flex items-center p-2 text-gray-700 {{ $currentRouteName == "verifikasi-data" ? "bg-active-side text-teal-800 font-medium border-r-[3px]" : "hover:text-gray-950" }}"
        >
          <span class="text-xl ml-2 mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <li>
        <a
          wire:navigate
          href="{{ route("verifikasi-jadwal") }}"
          class="transition-all flex items-center p-2 text-gray-700 {{ $currentRouteName == "verifikasi-jadwal" ? "bg-active-side text-teal-800 font-medium border-r-[3px]" : "hover:text-gray-950" }}"
        >
          <span class="text-xl ml-2 mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <li>
        <a
          ...
          class="transition-all flex items-center p-2 text-gray-700 {{ $currentRouteName == "manajemen-user" ? "bg-active-side text-teal-800 font-medium border-r-[3px]" : "hover:text-gray-950" }}"
        >
          <span class="text-xl ml-2 mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
    ...
    @elseif (Auth::user()->role == 2)
      <li>
        <a
          wire:navigate
          href="{{ route("perubahan-data") }}"
          class="transition-all flex items-center p-2 text-gray-700 {{ $currentRouteName == "perubahan-data" ? "bg-active-side text-teal-800 font-medium border-r-[3px]" : "hover:text-gray-950" }}"
        >
          <span class="text-xl ml-2 mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <span :class="sidebarOpen ? 'inline' : 'hidden'">
