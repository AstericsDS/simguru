            ...
            @foreach ($campuses as $campus)
                <tr>
                    ...
                    <td class="flex flex-col gap-2">
                        <a href="edit-kampus" type="button" class="px-1 py-1 text-xs font-medium text-center text-white bg-blue-700 rounded-sm hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                            Edit
                        </a>
                        ...
                        <a href="" type="button" class="px-1 py-1 text-xs font-medium text-center text-white bg-red-700 rounded-sm hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300">
                            Hapus
                        </a>
                    </td>
                </tr>
